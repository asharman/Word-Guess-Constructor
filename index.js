...
let game = {
  ...
  promptUser: function() {
    ...
    if (this.guessesRemaining > 0) {
      ...
      inquirer
        .prompt([
          // Give the user the option to guess the word
          {
            type: "list",
            name: "guessWordOrLetter",
            message: "What would you like to do?",
            choices: ["Guess a letter", "Guess the word"]
          },
          {
            type: "input",
            name: "wordGuess",
            ...
            when: function(answer) {
              return answer.guessWordOrLetter === "Guess the word";
            }
          },
          {
            type: "input",
            ...
            when: function(answer) {
              return answer.guessWordOrLetter === "Guess a letter";
            },
        ...
        .then(res => {
          ...
          } else if (res.wordGuess) {
            let guess = res.wordGuess;
            let guessBool = this.currentWord.guessWord(guess);
            if (guessBool) {
              this.guessedCorrectly();
            } else {
      ...
      console.log(`The currect word was "${this.currentWord.word}".`);
    }
  }
};
